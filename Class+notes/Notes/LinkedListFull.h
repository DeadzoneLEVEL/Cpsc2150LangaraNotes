...
public:
  ...
  T removeLast();
  // T removeLastRecursive(Node<T> *current = head,int i=0);
...
// template<typename T>
// T LinkedList<T>::removeLast(){
//   return removeLastRecursive(head,0);
// }

// template<typename T>
// T LinkedList<T>::removeLastRecursive(Node<T> *current,int i){
//   if(size==0){
//     std::cout<<"Screw off"<<std::endl;
//   }else if(size==1){
//     Node<T> *temp = head;
//     head = tail = NULL;
//     size = 0;
...
//     return element;
//   }else{
//     removeLastRecursive(current->next,i+1)
//   }
// }
...
template<typename T>
void LinkedList<T>::GetCurrRec(Node<T> *&current){
