...
class Graph{
    private:
        ...
        void makeAdjacencyList(unsigned adjacencyMatrix[3][4],int h,int w);
        void makeVertices(unsigned adjacencyMatrix[3][4],int h,int w);
    ...
    public:
        Graph();
        Graph(unsigned adjacencyMatrix[3][4], int _height,int _width);
...
Graph::Graph(unsigned adjacencyMatrix[3][4], int _height,int _width){
...
void Graph::makeAdjacencyList(unsigned adjacencyMatrix[3][4],int h,int w){
